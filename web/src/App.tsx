...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    <main id="main-content" className="main-content">
      {section === "feed" && <FeedScreen posts={posts} source={feedSource} onCompose={() => setComposeOpen(true)} onOpenProfile={openProfile} onViewJob={(jobId)=>{setSection("jobs");setNotice({tone:"info",message:`Opened ${jobId.replaceAll("_"," ")}.`});}} onNotice={setNotice} />}
